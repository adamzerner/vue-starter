...
4. Set `VUE_APP_BASE_URL` to your API server in `.env.development` (eg. `localhost:3000`)
5. Make sure your API server (eg. [NodeStarter](https://github.com/adamzerner/node-starter)) is up and running
